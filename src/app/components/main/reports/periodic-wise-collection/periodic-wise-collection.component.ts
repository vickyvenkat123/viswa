...
@Component({
  selector: 'app-periodic-wise-collection',
  templateUrl: './periodic-wise-collection.component.html',
  styleUrls: ['./periodic-wise-collection.component.scss']
})
export class PeriodicWiseCollectionComponent implements OnInit {
  ...
  public displayedColumns = ['createdAt', 'customer_code', 'customer_name', 'recipt_no', 'invoice_number', 'amount'];
