...
@Component({
  selector: 'app-daily-field-activity',
  templateUrl: './daily-field-activity.component.html',
  styleUrls: ['./daily-field-activity.component.scss']
})
export class DailyFieldActivityComponent implements OnInit {

  @ViewChild(MatPaginator, { static: true }) paginator: MatPaginator;
  itemSource = new MatTableDataSource();
  private subscriptions: Subscription[] = [];
  public displayedColumns = ['created_at', 'salesman_code', 'salesman_name', 'total_visited_shpos', 'total_invoice_shop', 'cash_sale', 'credit_sale', 'cash_collection', 'check_collection'];
