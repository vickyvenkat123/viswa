...
@Component({
  selector: 'app-van-customer',
  templateUrl: './van-customer.component.html',
  styleUrls: ['./van-customer.component.scss']
})
export class VanCustomerComponent implements OnInit {

  @ViewChild(MatPaginator, { static: true }) paginator: MatPaginator;
  itemSource = new MatTableDataSource();
  private subscriptions: Subscription[] = [];
  public displayedColumns = ['customer_code', 'name', 'type', 'address', 'contact'];
