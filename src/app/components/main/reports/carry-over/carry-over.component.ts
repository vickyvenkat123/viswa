...
@Component({
  selector: 'app-carry-over',
  templateUrl: './carry-over.component.html',
  styleUrls: ['./carry-over.component.scss'],
  animations: [
...
export class CarryOverComponent implements OnInit {

  @ViewChild(MatPaginator, { static: true }) paginator: MatPaginator;
  itemSource = new MatTableDataSource();
  private subscriptions: Subscription[] = [];
  public displayedColumns = ['created_at', 'route_code', 'route', 'carryoverno', 'trip_id'];
