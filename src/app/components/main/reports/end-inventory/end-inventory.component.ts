...
@Component({
  selector: 'app-end-inventory',
  templateUrl: './end-inventory.component.html',
  styleUrls: ['./end-inventory.component.scss']
})
export class EndInventoryComponent implements OnInit {
  @ViewChild(MatPaginator, { static: true }) paginator: MatPaginator;
  itemSource = new MatTableDataSource();
  private subscriptions: Subscription[] = [];
  public displayedColumns = ['item_code', 'item_name', 'salesman_fullname', 'total_load_qty', 'total_sales_qty', 'total_return_qty', "total_bad_return_qty", 'total_unload_qty'];
