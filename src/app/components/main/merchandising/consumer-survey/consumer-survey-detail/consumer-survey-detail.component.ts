...
@Component({
  selector: 'app-consumer-survey-detail',
  templateUrl: './consumer-survey-detail.component.html',
  styleUrls: ['./consumer-survey-detail.component.scss']
})
export class ConsumerSurveyDetailComponent extends BaseComponent implements OnInit {
  @Output() public detailsClosed: EventEmitter<any> = new EventEmitter<any>();
  @Output() public updateTableData: EventEmitter<any> = new EventEmitter<any>();
  @Input() public Survey: Survey;
  @Input() public loadChnages: any;
  ...
  public editSruvey(data): void {
    ...
    this.formDrawer.setFormName('add-ConsumerSurvey');
  ...
  ngAfterViewChecked() {
    const container: any = document.querySelector('.mat-horizontal-content-container');
    if (container) {
  ...
  public deleteBank(): void {
    ...
    this.merService.deleteConsumerSurvey(this.Survey.uuid).subscribe(result => {
      this.closeDetailView();
