...
export class DemageListComponent implements OnInit {
  ...
  public displayedColumns = ['created_at', 'salesman', 'CustomerCode', 'customer', 'itemCode', 'item', 'damage_item_qty', 'expire_item_qty', 'saleable_item_qty'];
  ...
  ngOnInit(): void {
    ...
    this.filterForm = this.fb.group({
      assign_inventory_id: [this.stockId],
      date: [''],
      salesman_name: [''],
      item_name: [''],
      item_code: [''],
  ...
  getDamageItemList(filter, value) {
    ...
    this.filterForm.get('assign_inventory_id').setValue(this.stockId);
    this.filterData();
  }
  filterData() {
    this.subscriptions.push(
      this.merService.getStockDamageItemList(this.filterForm.value).subscribe((res) => {
