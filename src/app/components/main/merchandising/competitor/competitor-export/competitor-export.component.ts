...
@Component({
  selector: 'app-competitor-export',
  templateUrl: './competitor-export.component.html',
  styleUrls: ['./competitor-export.component.scss']
})
export class CompetitorExportComponent implements OnInit {
