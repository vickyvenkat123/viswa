...
@Component({
  selector: 'app-rebate-page',
  templateUrl: './rebate-page.component.html',
  styleUrls: ['./rebate-page.component.scss']
})
export class RebatePageComponent extends BaseComponent implements OnInit {

  public isDetailVisible: boolean;
  public rebate: any;
  checkedRows = [];
  public newRebateData = {};
  ...
  ngOnInit(): void { }
  openAddPricing() {
    this.router.navigate(['pricing-plan/rebate/add']);
  }
