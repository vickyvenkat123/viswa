...
export class TaxRatesComponent extends BaseComponent implements OnInit {

  @ViewChild('formDrawer') TaxFormDrawer: MatDrawer;
  ...
  ngAfterViewInit(): void {
    this.fds.setDrawer(this.TaxFormDrawer);
  }
  openAddTax() {
    this.fds.setFormName('add-Tax');
