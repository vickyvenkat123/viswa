...
//import { Cashier } from '../../cashier-receipt/cashier-reciept-master-page/cashier-reciept-master-page.component';

@Component({
  selector: 'app-pdc-master',
  templateUrl: './pdc-master.component.html',
  styleUrls: ['./pdc-master.component.scss']
})
export class PdcMasterComponent extends BaseComponent
  implements OnInit {
  ...
  openAddCashier() {
    this.router.navigate(['finance/pdc/add']);
  }
