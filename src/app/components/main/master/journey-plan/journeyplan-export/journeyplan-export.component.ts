...
@Component({
  selector: 'app-journeyplan-export',
  templateUrl: './journeyplan-export.component.html',
  styleUrls: ['./journeyplan-export.component.scss']
})
export class JourneyplanExportComponent implements OnInit {
