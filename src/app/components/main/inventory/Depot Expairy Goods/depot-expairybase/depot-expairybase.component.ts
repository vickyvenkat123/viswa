...
@Component({
  selector: 'app-depot-expairybase',
  templateUrl: './depot-expairybase.component.html',
  styleUrls: ['./depot-expairybase.component.scss'],
})
export class DepotExpairybaseComponent extends BaseComponent {
  public isDetailVisible: boolean;
  public checkedRows = [];
  public newDepotExpData = {};
  ...
  public openForm() {
    this.router.navigate(['inventory/depot-expairy', 'add']);
  }
