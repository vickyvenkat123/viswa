...
@Component({
  selector: 'app-debit-note-export',
  templateUrl: './debit-note-export.component.html',
  styleUrls: ['./debit-note-export.component.scss']
})
export class DebitNoteExportComponent implements OnInit {
  ...
  constructor(datePipe: DatePipe,
    ...
    Object.assign(this, { apiService, debitNoteService });
  }
  ...
  exportDebit() {
    ...
    this.debitNoteService.exportDebit({
      module: 'debitnote',
